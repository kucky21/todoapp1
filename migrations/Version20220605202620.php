 ...
 */
final class Version20220605202620 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_2FB3D0EEE3272D31 ON project');
        $this->addSql('ALTER TABLE project DROP tasks_id');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE project ADD tasks_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE project ADD CONSTRAINT FK_2FB3D0EEE3272D31 FOREIGN KEY (tasks_id) REFERENCES task (id)');
        $this->addSql('CREATE INDEX IDX_2FB3D0EEE3272D31 ON project (tasks_id)');
